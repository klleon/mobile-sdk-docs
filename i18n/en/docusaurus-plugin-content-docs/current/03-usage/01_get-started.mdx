...
Before using the Klleon Chat SDK, you need the following:
...
2.  **SDK Key Issuance**: After domain registration, a unique `sdk_key` will be issued for use with that domain. This key is required for SDK initialization.
...
3. Review [Usage Examples](../examples/examples) for implementation patterns
