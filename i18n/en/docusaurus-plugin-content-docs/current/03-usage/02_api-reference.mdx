...
Starts video playback with facial recognition processing.
...
- `facialPath`: String - Absolute path to facial processing file (.npz)
...
**State Format:**
The state is typically a JSON string containing the following:
```json
{
