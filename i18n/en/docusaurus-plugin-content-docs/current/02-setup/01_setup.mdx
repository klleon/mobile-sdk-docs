...
Klleon Ondevice SDK is an Android SDK that provides on-device AI functionality along with video processing, real-time messaging, and WebSocket communication. This document is based on the implementation of a sample Android application.
